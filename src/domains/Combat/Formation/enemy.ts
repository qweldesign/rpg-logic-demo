...
export function enemySetup(saveData: SaveData, enemy: string = 'sample', seed: number = 0): { models: UnitModel[], rewardCp: number, rewardGold: number } {
  // セーブデータの読み込み
  ...
  if (enemy === 'goblin') {
    ...
    return { models, rewardCp, rewardGold }
  }
